...
public interface IReleaseTestCaseBugService {

	ReleaseTestCaseBug persistReleaseTestCaseBug(int clientProjectId,
	...
	List<ReleaseTestCaseBug> getReleaseTestCaseBugByTestCaseId(int releaseTestCaseBugId, String applicable, String isDeleted)
			throws APIExceptions;
}
